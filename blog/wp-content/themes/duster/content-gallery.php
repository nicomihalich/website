...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		...
		<?php if ( post_password_required() ) : ?>
			...
			<?php else : ?>
				...
				<p><em><?php printf( _n( 'This gallery contains <a %1$s>%2$s photo</a>.', 'This gallery contains <a %1$s>%2$s photos</a>.', $total_images, 'duster' ),
						'href="' . get_permalink() . '" title="' . sprintf( esc_attr__( 'Permalink to %s', 'duster' ), the_title_attribute( 'echo=0' ) ) . '" rel="bookmark"',
	...
	<footer class="entry-meta">
		...
		<span class="comments-link"><?php comments_popup_link( __( 'Leave a reply', 'duster' ), __( '1 reply', 'duster' ), __( '% replies', 'duster' ) ); ?></span>
